...
export function MediaCard({
  ...
  return (
    ...
    >
      <button
        className="absolute inset-0 w-full h-full z-0 cursor-pointer opacity-0 focus:outline-none"
        onClick={onClick}
      ...
      <CardContent className="p-0 relative z-10 pointer-events-none">
        ...
        <div className="p-4 bg-slate-900 border-t border-slate-800/60 pointer-events-auto">
