...
/**
 * Define as regras de segurança HTTP para o microserviço de favoritos.
 */
@Configuration
@EnableWebSecurity
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/admin/**", "/lms-favorite/admin/**").hasRole("ADMIN")
                        .requestMatchers("/user/**", "/lms-favorite/user/**").hasAnyRole("USER", "ADMIN")
